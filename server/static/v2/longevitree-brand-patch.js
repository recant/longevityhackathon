(function () {
  ...
  function drawTreatmentMarkers() {
    ...
    if (graphSection && !document.getElementById('ltTreatmentSummary')) {
  ...
  window.addEventListener('message', (event) => {
    if (String(event.data?.type || '').includes('assessment-saved') || String(event.data?.type || '').includes('workflow-finished')) {
